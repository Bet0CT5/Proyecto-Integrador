...
<body>
    ...
    <div class="container">
        ...
        <div class="info-container-big">
          <h2> Estatus de faltas justificadas</h2>
  ...
  <tbody>
    ...
    <?php
      ...
      $consulta = "SELECT fj.id_falta, g.crn_grupo, m.nombre_materia, fj.fecha, fj.estatus
                   FROM falta_justificada fj
                   INNER JOIN grupo g ON fj.crn_grupo = g.crn_grupo
                   INNER JOIN materia m ON g.clave_materia = m.clave_materia
                   WHERE fj.id_maestro = :id_maestro";
